		...
		<div class="regist_block">
			...
			<form action="regist" method="POST" name="registerForm" novalidate>
				...
				<p><label class="lable_input">请输入账号：</label>
					<input type="text" name="user_name" id="user" class="text_input" ng-model="user" placeholder="请输入您的账号" required><br/></p>
					<p><span style="color: red" ng-show=" registerForm.user.$invalid">
					</span></p>
				<p><label class="lable_input">请输入密码：</label>
					<input type="password" name="user_password1" class="text_input" ng-model="user_password1" ng-minlength="8" ng-maxlength="20" placeholder="请输入您的密码" required><br/></p>
				...
				<p><label class="lable_input">请确认密码：</label>
					<input type="password" name="user_password2" class="text_input" ng-model="user_password2" placeholder="重复输入密码" required></p>
				...
				<p><label class="lable_input">输入验证码：</label>
					<input type="text" name="yanzhengma" class="text_input" placeholder="请输入邮箱验证码" required>
